...
s.box(535, 690, 568, 762, 94, 104, '#B0E0F8')
s.box(562, 682, 590, 762, 94, 104, '#F8B8E0')
...
# chalk box in the left hand
s.box(66, 684, 214, 800, 70, 150, '#F8F8FA').f(R(66, 786, 214, 800), '#60B0F0')
