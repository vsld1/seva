...
for f in BOTH:
    ...
    gem(s, f(333), 924, 22, 88, 96, '#F888D0')
...
# crystal comb in the left hand
s.box(98, 684, 180, 740, 70, 116, '#F0F4F8')
for x in (110, 124, 138, 152, 166):
    s.prism(P((x, 738), (x + 10, 738), (x + 5, 768)), 84, 100, '#F0F6FC')
s.cube(70, 648, 92, 76, 74, 60, '#C8F4FC')
s.prism(RR(130, 632, 20, 60, -20), 100, 112, '#C080F0')
s.prism(RR(142, 668, 20, 56, -30), 108, 118, '#40D8E8')
...
for f in BOTH:
    head.f(R(f(268), 386, f(326), 414), '#F8C0D8')
