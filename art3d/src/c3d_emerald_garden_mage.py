...
# an emerald with leaves in the left hand
s.cube(170, 842, 80, 70, 54, 50, '#80E878', rz=10)
s.cube(330, 840, 80, 70, 60, 50, '#80E878', rz=-6)
s.cube(225, 835, 110, 100, 100, 90, '#40E8C0', rz=30, ry=20)
...
# face
for x, hx in ((492, 498), (M(552), M(546))):
    head.f(R(x, 435, x + 60, 528), '#0A6A1A').f(R(hx, 448, hx + 22, 475), '#FFFFFF')
for f in BOTH:
    head.f(R(f(450), 535, f(505), 560), '#F8B8A8')
