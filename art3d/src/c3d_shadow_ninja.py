...
# crystal kunai held point-down in the left hand
k = s.prism(P((212, 836), (266, 836), (262, 1060), (238, 1110), (214, 1060)), 86, 126, '#1860F0')
k.f(P((248, 836), (266, 836), (262, 1060), (248, 1090)), MAG).f(P((212, 836), (226, 836), (226, 1080), (214, 1060)), '#6A9AF8')
s.box(214, 758, 300, 836, 80, 132, '#1A1E36')
