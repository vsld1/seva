...
# bamboo staff held across the chest
s.prism(B((420, 874), (714, 524), 24), 118, 142, '#20B020')
s.prism(RR(628, 606, 48, 18, -40), 138, 146, '#B8E840')
s.prism(RR(488, 774, 48, 18, -40), 138, 146, '#B8E840')
