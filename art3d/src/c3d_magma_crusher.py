...
for a, b in (((455, 572), (428, 632)), ((M(455), 572), (M(428), 632)), ((458, 690), (484, 724))):
...
# magma pick in the left hand: grip, blue core, lava tip
s.box(226, 574, 280, 636, 82, 130, '#7A5A50')
s.box(222, 630, 274, 818, 86, 126, '#2E5BE0')
s.box(215, 812, 278, 882, 80, 132, LAVA)
