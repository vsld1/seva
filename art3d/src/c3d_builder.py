...
# trowel held in the left hand: flat grey blade on a short handle
s.box(132, 588, 244, 690, 60, 114, '#FFE000')
s.box(146, 600, 224, 670, 112, 118, '#5A5E70')
s.prism(P((40, 572), (126, 540), (256, 566), (172, 598)), 116, 128, '#A0A4B8')
s.prism(B((170, 606), (160, 560), 12), 116, 130, '#6A7084')
