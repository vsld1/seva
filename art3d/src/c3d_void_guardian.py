...
# void shield in the left hand, held edge-on
s.box(214, 900, 300, 1188, 70, 150, '#0C0C30')
s.box(208, 1148, 306, 1190, 66, 154, MAG)
s.prism(E(257, 1020, 30, 70), 148, 156, MAG)
s.prism(E(257, 1020, 20, 56), 155, 160, '#000000', line=False)
