...
# purple staff with a white orb, held upright in the left hand
s.box(234, 880, 276, 972, 90, 124, '#FFFFFF')
s.box(234, 508, 290, 892, 78, 134, '#C890F8')
s.sphere(262, 704, 138, 38, '#FFFFFF')
