...
# golden key with an ice crystal, held upright in the left hand
s.prism(B((284, 1004), (246, 852), 40), 74, 112, '#A0E8F4')
s.box(186, 998, 272, 1080, 70, 120, '#E8B830')
s.box(176, 1074, 246, 1170, 72, 110, '#A07020')
