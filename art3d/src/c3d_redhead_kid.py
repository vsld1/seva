...
# glowing lantern in the left hand
s.box(220, 598, 258, 636, 64, 92, '#5A3420')
s.box(188, 514, 262, 606, 62, 122, '#3A2A1A').f(R(188, 584, 262, 606), '#241910').f(
    R(198, 522, 252, 580), '#FFF000', line=True).f(R(198, 522, 216, 540), '#FFFFB0')

# head: long hair at the sides, face, hair on top, headband with a knot
s.box(300, 150, 322, 300, -90, 70, HAIR)
s.box(M(322), 150, M(300), 248, -90, 70, HAIR)
