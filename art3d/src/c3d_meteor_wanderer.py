...
rock(238, 470, 84, -8, '#5A3A30', z=-20, glow=(-30, 10, -20, 22))
...
# the big meteor in the left hand, small rocks around it
rock(245, 610, 150, -30, z=96, glow=(-44, -40, -8, -30))
rock(156, 535, 56, -15, '#7A5A48', z=60)
rock(158, 656, 40, 10, '#6A4636', z=150, glow=(-8, -4, 4, 6))
