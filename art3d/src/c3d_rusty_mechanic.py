...
# giant wrench held upright in the left hand
s.prism(B((122, 800), (130, 560), 58), 60, 118, '#A8ACBE')
s.box(73, 541, 163, 615, 56, 122, '#BCC0CE')
s.box(64, 723, 148, 793, 56, 122, '#BCC0CE')
...
for f in BOTH:
    head.f(P((f(330), 336), (f(396), 330), (f(396), 348), (f(330), 354)), '#6A1A08')
for x in (334, M(386)):
