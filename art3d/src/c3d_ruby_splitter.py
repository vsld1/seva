...
# splitting axe held upright in the left hand, yellow sparks at the base
axe = s.box(160, 664, 256, 914, 56, 110, '#2A3048').f(R(224, 745, 248, 850), '#E0208A')
s.box(150, 906, 246, 950, 54, 112, '#C8C8D8')
for x, y, r in ((134, 960, 20), (245, 960, 14)):
    s.cube(x, y, 100, r * 1.3, r * 1.3, r * 1.3, '#FFF000', rz=45, ry=20)
