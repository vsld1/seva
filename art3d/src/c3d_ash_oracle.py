...
# dark staff with a yellow edge, held slanting down from the left hand
st = s.prism(B((220, 580), (176, 950), 44), 70, 110, '#3A3A4E')
st.f(B((202, 580), (156, 950), 12), YEL)
s.box(190, 566, 264, 652, 66, 112, '#2E3450')
