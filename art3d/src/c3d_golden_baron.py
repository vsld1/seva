...
# cane with a gold knob set with a ruby
s.prism(B((172, 600), (130, 530), 16), 50, 66, '#1A2438')
s.sphere(125, 520, 60, 30, GOLD)
gem(s, 121, 514, 15, 88, 96, '#FF2050')
...
s.prism(P((275, 352), (405, 352), (405, 390), (384, 390), (384, 372), (298, 372), (298, 390), (275, 390)), 82, 92, '#4A1A08')
