...
for f in BOTH:
    s.box(f(265), 688, f(410), 792, -70, 70, '#1FB81C')
    s.box(f(262), 782, f(400), 848, -72, 100, G_DK)
    for x in (280, 322, 362):
...
# white bone chunk in the left hand
s.box(124, 548, 184, 640, 70, 122, '#FFFFFF')
s.box(182, 548, 246, 646, 70, 122, '#FFFDF4')
