...
# skull staff in the left hand
s.prism(B((268, 712), (262, 628), 34), 52, 86, '#4A2418')
s.box(290, 596, 326, 618, 56, 82, BONE)
skull = s.box(196, 524, 296, 642, 42, 104, '#F7F2EA').f(R(196, 612, 296, 642), '#DDD6CC').f(
    R(212, 578, 234, 598), CYAN).f(R(258, 578, 280, 598), CYAN)
for x in (226, 244, 262):
    skull.f(R(x, 616, x + 4, 642), '#8E877C')
s.box(180, 592, 198, 610, 60, 84, '#FF2A2A')
