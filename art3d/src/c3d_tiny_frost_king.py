...
# ice orb scepter held across the left hand
s.box(292, 820, 326, 846, 60, 110, '#6A4A28')
s.box(110, 770, 172, 802, 70, 110, SNOW)
s.box(258, 776, 330, 806, 70, 110, SNOW)
s.sphere(222, 790, 92, 44, '#C8E8F8')
s.cube(212, 782, 128, 44, 44, 30, '#A8D8F0', rz=45)
