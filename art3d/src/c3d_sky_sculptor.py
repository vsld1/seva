...
# white sculpting stone in the left hand
s.cube(262, 780, 96, 118, 108, 104, '#F8F8FC', rz=-18, ry=16)
...
for x, hx in ((427, 450), (M(478), M(462))):
    head.f(R(x, 412, x + 51, 472), '#0A5AE8').f(R(hx, 416, hx + 12, 446), '#FFFFFF')
