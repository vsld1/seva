...
# face: brows, eyes, stubble, big nose, bushy moustache
head.f(R(366, 252, 460, 282), '#7A2A10').f(R(540, 252, 634, 282), '#7A2A10')
for x in (380, 556):
    head.f(R(x, 290, x + 62, 368), '#0A0A20').f(R(x + 12, 296, x + 28, 330), '#FFFFFF')
head.f(R(344, 420, M(344) + 20, 526), '#E8B47A')
s.prism(P((402, 414), (M(402), 414), (M(402), 446), (M(426), 468), (M(470), 450), (470, 450), (426, 468), (402, 446)), 110, 124, '#7A2A08')
