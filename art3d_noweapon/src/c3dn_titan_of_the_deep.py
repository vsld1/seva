...
# left arm (hidden behind the slab in the game), mirrored from the right one
s.box(M(1115), 686, M(895), 780, -100, 100, '#48475E')
s.box(M(1116), 772, M(890), 942, -104, 104, '#3E3D55').f(R(M(1045), 856, M(955), 868), RUNE)
s.cube(M(1030), 592, 0, 290, 192, 230, ST, rz=-8)
